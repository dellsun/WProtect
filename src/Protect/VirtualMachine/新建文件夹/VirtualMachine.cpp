...
void VirtualMachine::add_pcode(
                               AsmJit::Assembler &a,PCode *code,long base,
                               long ret_address,long v_key,long decryption_key) //true表示正
{
...
ppcode_block_info VirtualMachine::add_new_function(
                                                   long base,PCode *code,long ret_address,
                                                   long v_key,long decryption_key)
